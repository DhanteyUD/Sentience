const INFO_ROWS = [
  ...
  { label: 'Encryption',     value: 'AES-256-CBC',          color: 'text-emerald-400' },
  { label: 'Key Derivation', value: 'PBKDF2 (10k iter)',    color: 'text-emerald-400' },
  { label: 'Signing',        value: 'Ed25519 Auto',         color: 'text-white' },
  { label: 'DEX',            value: 'Jupiter V6',           color: 'text-white' },
  { label: 'Framework',      value: 'Custom + EventEmitter',color: 'text-violet-400' },
]
