...
export const ACTION_COLORS: Record<string, string> = {
  ...
  ADD_LIQUIDITY: 'bg-emerald-500/15 text-emerald-400 border border-emerald-500/30',
...
export const RISK_CONFIG = {
  ...
  MEDIUM:   { dot: 'bg-amber-400 animate-pulse', text: 'text-amber-400', label: 'MED' },
  HIGH:     { dot: 'bg-rose-400 animate-pulse', text: 'text-rose-400', label: 'HIGH' },
  CRITICAL: { dot: 'bg-rose-400 animate-ping', text: 'text-rose-400', label: 'CRIT' },
}

export const STATUS_CONFIG = {
  running: 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/25',
